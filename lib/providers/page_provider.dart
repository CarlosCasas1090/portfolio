...
class PageProvider extends ChangeNotifier
{
  ...
  List<String> _pages = ['home', 'about', 'experience', 'projects','projects2', 'contact'];
  int _currentIndex = 0;
  ...
  createScrollController(String routeName)
  {
    ...
    html.document.title = 'Juan Carlos Casas | ' + _pages[getPageIndex(routeName)].toUpperCase();
    ...
    this.scrollController.addListener(() 
    {
      ...
      if (index != _currentIndex)
      {
        ...
        _currentIndex = index;
        html.document.title = 'Juan Carlos Casas | ' + _pages[index].toUpperCase();
      }
    });
  }
